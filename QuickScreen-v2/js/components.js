window.QSUI={
 ...
 shell(content,active='clients'){return `<header class="topbar"><div class="topbar-inner"><a class="brand" href="#/clients"><img src="assets/logo/kb-logo.png" alt="KB Trener"><span class="brand-copy"><strong>KB Trener</strong><small><b>QuickScreen</b> · zapisano lokalnie</small></span><span class="module">QuickScreen <span>▾</span></span></a><div class="top-actions"><span class="cloud">☁</span><a class="avatar" href="#/trainer" title="Profil trenera">KB</a></div></div></header>${content}<nav class="bottom-nav"><div class="bottom-nav-inner">${[['clients','♧','Klienci','#/clients'],['assessment','⊕','Badanie','#/assessment'],['config','☷','Konfiguracja','#/configuration']].map(x=>`<a class="nav-item ${active===x[0]?'active':''}" href="${x[3]}"><span class="icon">${x[1]}</span>${x[2]}</a>`).join('')}</div></nav><button class="nav-fab" data-action="navigator" aria-label="Prototype Navigator">⌘</button>`},
