...
## 17. Nagłówek i odpowiedź muszą pasować znaczeniowo

Nagłówek jest pytaniem albo zapowiedzią konkretnego rodzaju informacji. Tekst pod nim ma odpowiadać dokładnie na ten rodzaj pytania.
...
## 18. Główna część raportu nie jest protokołem testu

W głównej części raportu klient powinien czytać o szyi, barku, skłonie, przysiadzie, równowadze, rotacji, bólu i różnicy między stronami.

Nazwy `Toe Touch`, `Shoulder Clearing`, `Cervical Rotation + Extension` i podobne zostaw do szczegółów technicznych.
...
Nie zaczynaj sekcji od `to`, `ten problem`, `ten obszar` lub `ten ruch`, jeżeli nie wiadomo bezpośrednio, czego dotyczą.
