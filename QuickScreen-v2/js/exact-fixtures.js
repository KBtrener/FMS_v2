...
const roleTabs=(active)=>`<nav class="role-tabs" aria-label="Widoki ról"><a class="${active==='client'?'active':''}" href="#/client-panel">Panel klienta</a><a class="${active==='trainer'?'active':''}" href="#/trainer-panel">Panel trenera</a><a class="${active==='admin'?'active':''}" href="#/admin-panel">Panel administratora</a></nav>`;
QSViews.clientPanel=function(){const c=QS.client;return QSViews.layout(`<div class="role-dashboard"><div class="page-head"><div><div class="eyebrow">Strefa klienta · QuickScreen</div><h1>Dzień dobry, ${c.name.split(' ')[0]}</h1><p>Twój spokojny podgląd postępów, wyników i kolejnych kroków.</p></div><div class="role-actions"><span class="badge badge-pass">Profil aktywny</span><a class="btn btn-outline" href="#/client/demo">Mój profil</a></div></div>${roleTabs('client')}<section class="role-hero client-hero"><div><span class="eyebrow">Ostatni screening · 07.09.2026</span><h2>Twój wynik ruchowy</h2><p>Wynik pokazuje aktualny obraz screeningu. Porozmawiaj z trenerem o obszarach oznaczonych uwagą.</p><a class="btn btn-teal" href="#/assessment-details/demo">Zobacz szczegóły wyniku →</a></div><div class="role-score"><strong>5</strong><span>/15</span><em>${QSUI.status('pain','Do omówienia')}</em></div></section><div class="grid-3 role-stats"><section class="card stat"><span>Kompletne badania</span><strong>3</strong><span>ostatnie 90 dni</span></section><section class="card stat"><span>Trend</span><strong class="attention-number">−4</strong><span>pkt od poprzedniego badania</span></section><section class="card stat"><span>Obszary do obserwacji</span><strong>2</strong><span>asymetria i clearing</span></section></div><div class="grid-2 role-content"><section class="card"><div class="card-head"><div><h2>Ostatnie badania</h2><p class="muted">Historia zapisanych screeningów</p></div><a class="btn btn-soft btn-sm" href="#/client/demo">Pełna historia</a></div><div class="list role-list">${QS.history.map((h,i)=>`<div class="list-row"><div><b>${h.date}</b><p class="tiny muted">${h.note}</p></div><div class="role-list-end">${QSUI.status(h.status)}<a class="btn btn-ghost btn-sm" href="#/assessment-details/demo">Otwórz</a></div></div>`).join('')}</div></section><section class="card next-step-card"><div class="card-head"><div><span class="eyebrow">Zarządzanie profilem</span><h2>Twoje dane i dokumentacja</h2></div><span class="role-icon">✎</span></div><p>W makiecie możesz przejść przez pełny zestaw operacji na swoim profilu.</p><div class="quick-action-grid client-crud-actions"><a href="#/client/demo"><b>✎</b><span>Edytuj dane<small>Imię, e-mail i dyscyplina</small></span></a><a href="#/client/demo" data-action="toast" data-toast="Dodawanie notatki jest prezentacyjne w makiecie."><b>＋</b><span>Dodaj notatkę<small>Uzupełnij obserwacje</small></span></a><a href="#/client/demo" data-action="toast" data-toast="Dodawanie dokumentacji jest prezentacyjne w makiecie."><b>□</b><span>Dodaj dokument<small>Dołącz materiały do profilu</small></span></a><a href="#/client/demo" data-action="toast" data-toast="Usuwanie profilu jest prezentacyjne w makiecie."><b>×</b><span>Usuń profil<small>Operacja wymaga potwierdzenia</small></span></a></div></section></div></div>`,'clients')};
QSViews.trainerPanel=function(){return QSViews.layout(`<div class="role-dashboard"><div class="page-head"><div><div class="eyebrow">Workspace trenera · QuickScreen</div><h1>Centrum pracy</h1><p>Najważniejsze zadania i sygnały z Twojej bazy klientów.</p></div><div class="role-actions"><span class="badge badge-info">Dzisiaj · 10 września</span><a class="btn btn-primary" href="#/assessment">＋ Nowe badanie</a></div></div>${roleTabs('trainer')}<div class="grid-3 role-stats"><section class="card stat"><span>Aktywni klienci</span><strong>24</strong><span class="positive">↑ 3 w tym miesiącu</span></section><section class="card stat"><span>Badania w toku</span><strong>2</strong><span>szkice zapisane lokalnie</span></section><section class="card stat"><span>Do obserwacji</span><strong class="attention-number">6</strong><span>ból, asymetria lub clearing</span></section></div><div class="grid-2 role-content"><section class="card priority-card"><div class="card-head"><div><span class="eyebrow">Wymaga uwagi</span><h2>Priorytety na dziś</h2></div><a class="btn btn-soft btn-sm" href="#/clients">Wszyscy klienci</a></div><div class="priority-list"><a class="priority-row" href="#/client/demo"><span class="initials">GK</span><span><b>Gaweł Kot</b><small>Ból po prawej stronie · 07.09.2026</small></span><span class="badge badge-pain">Pilne</span></a><a class="priority-row" href="#/client/kasia"><span class="initials">KW</span><span><b>Katarzyna Wiśniewska</b><small>Asymetria · ostatni wynik 8/15</small></span><span class="badge badge-attention">Uwaga</span></a><a class="priority-row" href="#/assessment/demo/6"><span class="initials">GK</span><span><b>Gaweł Kot</b><small>Wznowić szkic · Shoulder Clearing</small></span><span class="badge badge-info">Szkic</span></a></div></section><section class="card"><div class="card-head"><div><span class="eyebrow">Ostatnia aktywność</span><h2>Przegląd workspace</h2></div><a class="btn btn-ghost btn-sm" href="#/configuration">Ustawienia</a></div><div class="activity-list"><div><span class="activity-dot pass"></span><p><b>Anna Nowak</b> · badanie kompletne<small>13/15 · 12 min temu</small></p></div><div><span class="activity-dot info"></span><p><b>Gaweł Kot</b> · szkic badania zapisany<small>Shoulder Clearing · 38 min temu</small></p></div><div><span class="activity-dot attention"></span><p><b>System</b> · 3 reguły clearingu aktywne<small>Ostatnia synchronizacja · dzisiaj, 09:42</small></p></div></div></section></div><section class="card quick-actions"><div class="card-head"><div><span class="eyebrow">Skróty</span><h2>Co chcesz zrobić?</h2></div></div><div class="quick-action-grid"><a href="#/assessment"><b>＋</b><span>Rozpocznij badanie<small>Wybierz klienta i przejdź do wizarda</small></span></a><a href="#/clients"><b>⌕</b><span>Znajdź klienta<small>Otwórz profil i historię wyników</small></span></a><a href="#/configuration"><b>⚙</b><span>Skonfiguruj protokół<small>Testy i reguły clearingu</small></span></a></div></section></div>`,'clients')};
QSViews.adminPanel=function(){return QSViews.layout(`<div class="role-dashboard"><div class="page-head"><div><div class="eyebrow">Administracja · QuickScreen</div><h1>Centrum kontroli</h1><p>Zarządzaj zespołem, protokołem i bezpieczeństwem workspace.</p></div><div class="role-actions"><span class="badge badge-pass">System działa prawidłowo</span><a class="btn btn-outline" href="#/team">Zarządzaj zespołem</a></div></div>${roleTabs('admin')}<section class="admin-health"><div><span class="eyebrow">Stan workspace</span><h2>Wszystko gotowe do pracy</h2><p>Ostatnia synchronizacja danych zakończona dzisiaj o 09:42.</p></div><div class="health-meter"><span><i></i></span><b>100%</b><small>operacyjność</small></div></section><div class="grid-3 role-stats"><section class="card stat"><span>Członkowie zespołu</span><strong>2</strong><span>1 administrator · 1 trener</span></section><section class="card stat"><span>Aktywne testy</span><strong>9</strong><span>wersja protokołu 2026.09</span></section><section class="card stat"><span>Aktywne reguły</span><strong>${QS.rules.length}</strong><span>ostatnia zmiana dzisiaj</span></section></div><div class="grid-2 role-content"><section class="card"><div class="card-head"><div><span class="eyebrow">Dostęp i role</span><h2>Zespół workspace</h2></div><a class="btn btn-primary btn-sm" href="#/team">＋ Zaproś</a></div><div class="member-list"><div class="member-row"><span class="avatar">KB</span><span><b>Karol Bilecki</b><small>Administrator · Ty</small></span><span class="badge badge-pass">Aktywny</span><button class="btn btn-ghost btn-sm" aria-label="Opcje Karola">•••</button></div><div class="member-row"><span class="avatar member-teal">AN</span><span><b>Anna Nowak</b><small>Trener · ostatnia aktywność dzisiaj</small></span><span class="badge badge-pass">Aktywny</span><button class="btn btn-ghost btn-sm" aria-label="Opcje Anny">•••</button></div></div></section><section class="card"><div class="card-head"><div><span class="eyebrow">Konfiguracja</span><h2>Protokół QuickScreen</h2></div><a class="btn btn-soft btn-sm" href="#/configuration">Otwórz</a></div><div class="admin-config-list"><a href="#/configuration#catalog"><span class="role-icon">✓</span><span><b>Katalog testów</b><small>9 aktywnych etapów badania</small></span><strong>→</strong></a><a href="#/configuration#rules"><span class="role-icon">⌁</span><span><b>Reguły clearingu</b><small>${QS.rules.length} aktywne reguły automatyzacji</small></span><strong>→</strong></a><a href="#/trainer"><span class="role-icon">KB</span><span><b>Profil właściciela</b><small>Certyfikacje i dane konta</small></span><strong>→</strong></a></div></section></div><section class="card audit-card"><div class="card-head"><div><span class="eyebrow">Audyt</span><h2>Ostatnie zdarzenia</h2></div><a class="btn btn-ghost btn-sm" href="#/team">Pełny dziennik</a></div><div class="audit-grid"><span><b>09:42</b><small>Synchronizacja zakończona</small></span><span><b>09:17</b><small>Anna Nowak otworzyła profil klienta</small></span><span><b>Wczoraj</b><small>Zmieniono opis testu Toe Touch</small></span></div></section></div>`,'config')};
