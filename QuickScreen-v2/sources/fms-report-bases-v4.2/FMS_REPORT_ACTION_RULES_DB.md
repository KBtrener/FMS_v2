...
# 14. Action Rules a warstwa semantyczna

Ten plik pozostaje źródłem znaczenia dla:
- co robić,
- czego nie zwiększać / co ograniczyć,
- co można robić dalej,
- następnego kroku.

Nie używaj go jako bezpośredniego źródła nagłówków ani technicznych nazw w naturalnej części raportu.

Warstwa semantyczna może skrócić, odmienić lub połączyć tekst, ale nie może zmienić znaczenia Action Rule ani stworzyć nowego zalecenia.
