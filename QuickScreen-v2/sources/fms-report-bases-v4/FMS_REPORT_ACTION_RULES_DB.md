...
- `do_now`: `Kontynuuj aktywność, ale zwróć większą uwagę na słabszą stronę i jakość wykonania.`
- `temporarily_limit`: `Brak automatycznego ograniczenia tylko z powodu wyniku 3/2.`
- `can_continue`: `Normalny trening lub codzienna aktywność, jeśli ruch nie wywołuje bólu.`
...
- `active_do_now`: `Utrzymaj trening elementów, które nie prowokują bólu szyi.`
...
- `active_can_continue`: `Pozostałe bezbolesne elementy treningu możesz kontynuować.`
...
- `general_next_step`: `Jeśli ból się utrzymuje lub przeszkadza w funkcjonowaniu, warto sprawdzić ten obszar dokładniej.`
...
- `active_temporarily_limit`: `Nie ma potrzeby automatycznie ograniczać całego treningu. Nie forsuj jednak końcowego zakresu ani nie progresuj ćwiczeń wymagających dużej swobody szyi, jeśli kompensujesz ustawieniem całego tułowia.`
...
- `active_temporarily_limit`: `Nie progresuj głębszych, cięższych lub szybszych wariantów przysiadu, jeśli tracisz pozycję wymaganą w podstawowym teście.`
...
- `active_temporarily_limit`: `Nie progresuj najbardziej dynamicznych lub mocno obciążonych ruchów rotacyjnych, jeśli tracisz kontrolę albo kompensujesz ustawieniem stóp.`
- `active_can_continue`: `Pozostałe dobrze ocenione wzorce oraz wolniejsze, kontrolowane zadania rotacyjne.`
