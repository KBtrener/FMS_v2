(function(){
  ...
  function cleanDetails(){
    ...
    const group2=dependentGroup(bilateralPassBody(2,'Cervical Rotation and Extension',passData['Cervical Rotation and Extension']),clearingPainBody(2,'Neck Extension Clearing',clearingData['Neck Extension Clearing']),finalCard('Pass','pass'));
    ...
    const group9=dependentGroup(parentHead(7,'Squat'),spineClearingBody(7,'Spine Extension Clearing',clearingData['Spine Extension Clearing']),finalCard(scoreData.Squat.final,scoreData.Squat.kind));
