...
score 3 -> score_3
3/2 -> asymmetry_3_2
2/1 or 3/1 -> asymmetry_with_1
cervical FAIL -> cervical_fail
cervical PASS -> cervical_pass
```

`finding_type` służy do wyboru właściwego `message_intent` i szablonu. Nie jest tekstem dla klienta.
