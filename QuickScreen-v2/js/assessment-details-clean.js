(function(){
  ...
  const bilateralScore=(number,name,data)=>`<article class="assessment-group-card"><div class="assessment-group-main">${parentHead(number,name)}<div class="assessment-side-results">${scoreCard('Lewa strona',data.left)}${scoreCard('Prawa strona',data.right)}</div><div class="assessment-single-results"><strong class="${data.kind}">${data.base}</strong></div></div>${finalCard(data.final,data.kind)}</article>`;
  const singleScore=(number,name,data)=>`<article class="assessment-group-card"><div class="assessment-group-main">${parentHead(number,name)}<div class="assessment-single-results"><strong class="${data.kind}">${data.base}</strong></div></div>${finalCard(data.final,data.kind)}</article>`;
