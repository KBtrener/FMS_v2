...
await Promise.all(['index.html', 'design-system.css', 'final-wizard-v2.css', '.htaccess'].map(name => cp(resolve('web', name), resolve(out, name))));
await cp(resolve('web/assets'), resolve(out, 'assets'), { recursive: true });
