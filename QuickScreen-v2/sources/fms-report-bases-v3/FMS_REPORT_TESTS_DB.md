...
Jeśli Toe Touch jest dobry, a Squat ma 1, można napisać, że warto dokładniej sprawdzić, co ogranicza przysiad. Nie wskazuj automatycznie jednej przyczyny.
...
`positive_meaning`:
`Podczas wyprostu kręgosłupa pojawił się ból. To jest teraz ważniejsze niż ocena pozostałych szczegółów tego ruchu i warto sprawdzić problem dokładniej.`
