...
const url = process.env.SUPABASE_PROJECT_URL || env.SUPABASE_PROJECT_URL;
...
console.log(JSON.stringify({ source: root, imported: { clients: clientRows.length, assessments: assessmentRows.length, answers: answers.length, files: uploaded }, skipped: { clients: clients.length - clientRows.length, assessments: assessments.length - assessmentRows.length } }));
